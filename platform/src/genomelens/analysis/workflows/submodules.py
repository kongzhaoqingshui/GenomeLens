...
class SubModuleRegistry:
    ...
    def _register_builtin_jcvi_modules(self) -> None:
        ...
        self.register(self._build_mcscan_pairwise_module())
        ...
        self.register(self._build_catalog_ortholog_module())
    ...
    def _build_mcscan_pairwise_module(self) -> SubModuleSpec:
    ...
    def _build_catalog_ortholog_module(self) -> SubModuleSpec:
        return SubModuleSpec(
