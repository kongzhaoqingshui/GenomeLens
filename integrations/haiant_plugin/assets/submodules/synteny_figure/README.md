# gljcvi-synteny-figure — 双物种共线性图子模块插件
...
```powershell
GenomeLens.exe analyze submodule jcvi.graphics_synteny --input-ports "{\"species_pair\": \"input\", \"blocks\": \"pair.blocks\"}" --output-dir output --params "{...}" --formats svg --force
```
