...
- GUI 当前源码仍有旧请求草案模型遗留，后续开发应先完成协议迁移，再继续扩展页面。

## 文档索引

- [开发计划](./开发计划.md) —— 当前状态、V3 迁移路线、Phase A-F、三人分工、验收标准。
- [前后端数据契约](./前后端数据契约.md) —— `WorkflowRequest v3`、Tauri Command、事件流、`RunSummary v3`、artifact 视图。
